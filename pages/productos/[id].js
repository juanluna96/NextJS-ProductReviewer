...
const Producto = () => {
    ...
    const votarProducto = () => {
        ...
        setConsultarDB(true); //Hay un voto nuevo, por lo tanto consultar a la DB
    }
    ...
    const agregarComentario = (e) => {
        ...
        setConsultarDB(true); //Hay un comentario nuevo, por lo tanto consultar a la DB
    }
                            ...
                            <div className="contenedor">
                                ...
                                <ContenedorProducto>
                                    ...
                                    <aside>
                                        ...
                                        { puedeBorrar() &&
                                            <Boton fullWidth onClick={ eliminarProducto }>Eliminar producto</Boton>
                                        }
                                    </aside>
                                </ContenedorProducto>
                            </div>
